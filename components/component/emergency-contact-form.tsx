  ...
  return (
    <Card className="w-full max-w-2xl">
      <CardHeader>
        ...
        <CardDescription>Add the contact information for people we can reach in an emergency.</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="grid gap-4">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="email-1" type="email" placeholder="john@example.com" />
              </div>
            </div>
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="email-2" type="email" placeholder="jane@example.com" />
              </div>
            </div>
          </div>
          <Button>
