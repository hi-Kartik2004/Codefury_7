  ...
  return (
    ...
    >
      ...
      {newsReportedPoints.length > 0 &&
        newsReportedPoints.map((point: any, index: any) => (
          <Marker
            key={point.id}
          ...
          >
            <Popup>
              <div>
                <h1 className="text-2xl">{point.population} people impacted</h1>
                <Link
                  href={point?.read_url}
                  target="_blank"
      ...
      {userReportedPoints.length > 0 &&
        userReportedPoints.map((point: any, index: any) => (
          <Marker
            key={point.id}
            position={[point.lat, point.long]}
            icon={userIcon}
      ...
      {lostPeopleReportedPoints.length > 0 &&
        lostPeopleReportedPoints.map((point: any, index: any) => (
          <Marker
            key={point.id}
            position={[point.lat, point.long]}
            icon={lostIcon}
      ...
      {foundPeopleReportedPoints.length > 0 &&
        foundPeopleReportedPoints.map((point: any, index: any) => (
          <Marker
            key={point.id}
            position={[point.lat, point.long]}
            icon={foundIcon}
...
// If you need to use dynamic import in Next.js
...
export const MapWithNoSSR = dynamic(
